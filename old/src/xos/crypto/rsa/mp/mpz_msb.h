...
mp_size_t mpz_get_msb (unsigned char *, mp_size_t , mpz_srcptr);
#else /* if (__GNU_MP_VERSION > 2) */
mp_size_t mpz_get_msb _PROTO ((unsigned char *, mp_size_t , mpz_srcptr));
#endif /* if (__GNU_MP_VERSION > 2) */
/**
 **********************************************************************
 ...
 */
#if (__GNU_MP_VERSION > 2)
mp_size_t mpz_set_msb (mpz_ptr, const unsigned char *, mp_size_t);
#else /* if (__GNU_MP_VERSION > 2) */
